...
class ColorCorrection(nn.Module):
    ...
    def training_setup(self, training_args):
        color_use_mlp = True
        color_correction_lr_init = training_args.color_correction_lr_init
        color_correction_lr_final = training_args.color_correction_lr_final
        color_correction_max_steps = training_args.color_correction_max_steps
        if color_use_mlp:
            params = [
        ...
        self.color_correction_scheduler_args = get_expon_lr_func(
            ...
            lr_delay_mult=training_args.color_correction_lr_delay_mult,
