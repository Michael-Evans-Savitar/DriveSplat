...
def run_colmap_waymo(result, args):
    ...
    if shutil.which("colmap") is None:
        raise RuntimeError(
            "COLMAP executable was not found in PATH. Install COLMAP before "
            "training with init_mode='colmap', or place precomputed COLMAP "
            "files at <model_path>/colmap/triangulated/sparse/model/"
